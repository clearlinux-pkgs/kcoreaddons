...
Source0  : https://download.kde.org/stable/frameworks/6.14/kcoreaddons-6.14.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.14/kcoreaddons-6.14.0.tar.xz.sig
...
%setup -q -n kcoreaddons-6.14.0
cd %{_builddir}/kcoreaddons-6.14.0
pushd ..
cp -a kcoreaddons-6.14.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747063729
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/pkgconfig/KF6CoreAddons.pc

%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6CoreAddons.so.6.14.0
/V3/usr/lib64/qt6/qml/org/kde/coreaddons/libkcoreaddonsplugin.so
/usr/lib64/libKF6CoreAddons.so.6
/usr/lib64/libKF6CoreAddons.so.6.14.0
