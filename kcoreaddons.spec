...
Source0  : https://download.kde.org/stable/frameworks/5.67/kcoreaddons-5.67.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.67/kcoreaddons-5.67.0.tar.xz.sig
...
%prep
%setup -q -n kcoreaddons-5.67.0
cd %{_builddir}/kcoreaddons-5.67.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581277086
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kcoreaddons-5.67.0/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/kcoreaddons/77976f406ba34009d9ba5a43b882fe6de68e5175
cp %{_builddir}/kcoreaddons-5.67.0/COPYING.LGPL-2 %{buildroot}/usr/share/package-licenses/kcoreaddons/e1032d8ebe34bec76a9c2e7ef2d44f8dae227fa5
cp %{_builddir}/kcoreaddons-5.67.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/kcoreaddons/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5CoreAddons.so.5.67.0
