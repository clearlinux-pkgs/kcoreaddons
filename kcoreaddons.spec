...
Source0  : https://download.kde.org/stable/frameworks/6.11/kcoreaddons-6.11.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.11/kcoreaddons-6.11.0.tar.xz.sig
...
%setup -q -n kcoreaddons-6.11.0
cd %{_builddir}/kcoreaddons-6.11.0
pushd ..
cp -a kcoreaddons-6.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739558461
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6CoreAddons.so.6.11.0
