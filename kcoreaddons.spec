...
Version  : 6.1.0
Release  : 85
URL      : https://download.kde.org/stable/frameworks/6.1/kcoreaddons-6.1.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.1/kcoreaddons-6.1.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.1/kcoreaddons-6.1.0.tar.xz.sig
...
%setup -q -n kcoreaddons-6.1.0
cd %{_builddir}/kcoreaddons-6.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712944546
mkdir -p clr-build
pushd clr-build
