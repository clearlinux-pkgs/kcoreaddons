...
Version  : 5.104.0
Release  : 65
URL      : https://download.kde.org/stable/frameworks/5.104/kcoreaddons-5.104.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.104/kcoreaddons-5.104.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.104/kcoreaddons-5.104.0.tar.xz.sig
...
%prep
%setup -q -n kcoreaddons-5.104.0
cd %{_builddir}/kcoreaddons-5.104.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679516810
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5CoreAddons.so.5.104.0
