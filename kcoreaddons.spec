...
Version  : 6.4.0
Release  : 89
URL      : https://download.kde.org/stable/frameworks/6.4/kcoreaddons-6.4.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.4/kcoreaddons-6.4.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.4/kcoreaddons-6.4.0.tar.xz.sig
...
%setup -q -n kcoreaddons-6.4.0
cd %{_builddir}/kcoreaddons-6.4.0
pushd ..
cp -a kcoreaddons-6.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720805776
mkdir -p clr-build
pushd clr-build
